# Voter
[Git Source](https://github.com/alchemix-finance/alchemix-v2-dao/blob/d8d0b0d485c418b8ae578e8607716a71a6b37bf6/src/Voter.sol)
...
```solidity
uint256 public boostMultiplier = 5000;
```
